...
namespace WindowsFormsApp3
{
    public partial class Form1 : Form
    {
        ...
        {
            Form2 openform2 = new Form2(this);
            openform2.Show();
            Visible = false;
        }
        ...
        {
            Froms.Form3 openform3 = new Froms.Form3(this);
            openform3.Show();
            Visible = false;
        }
        ...
        private void button1_Click_2(object sender, EventArgs e)
        {
            ...
            {
                errorProvider1.SetError(txtLoginName, "Debe ingresar un nombre de usuarios");
                txtLoginName.Focus();
            }
            else
            {
            ...
            {
                errorProvider2.SetError(txtLoginPass, "Debe ingresar su contraseña");
                txtLoginPass.Focus();
            }
            else
            {
            ...
            if (Controller.ReturnCurrent() == null)
            {
                if (Controller.GetUsuarios() == null)
                {
                    MessageBox.Show("No existe ningun Usuario creado en nuestros registros.");
                }
                else
                {
            ...
            else if ((Controller.ReturnCurrent()).logedin == true)
            {
                Froms.Form3 openform3 = new Froms.Form3(this);
                openform3.Show();
                Visible = false;
